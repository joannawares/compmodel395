...
Question: Using the parameters that we have set for transmission and removal, approximately what percentage of the total population that becomes infected over 250 days? How do you know?
...
Let's see how large the herd immunity threshold is to prevent an epidemic from occuring while keeping the parameters the same.
...
Now set the amount of people in recovered to the herd immunity threshold, the rest but 1 in susceptible and 1 infected.

```{r, warning = FALSE}
```

Question: What did you expect to happen when you put in the herd immunity threshold in the recovered group at $t=0$? Did it happen?
...
Put in less people into the recovered group than needed for herd immunity and plot the three dependent variables over time.
```{r, warning = FALSE}

```

Question: What did you expect to happen when you put more people in the recovered group at $t=0$ than needed for herd immunity? Did it happen?
...
Question: So what percentage of people get infected for these parameters if only one person is infected at t=0?
...
## Summary
Write a summary about what you have learned about herd immunity here and how it relates to $R_0$ and therefore $\beta$ and $\gamma$. In particular, why do you think more people in CASES 1 and 2 became infected than the herd immunity size?
